...
const NewsLetter = () => {
  return (
    <div className=' relative flex flex-col justify-center items-center mx-16 mb-16 gap-20 mt-32 bg-[#DFD7F9] rounded-tl-[7rem] p-10 py-20'>
        ...
        <button className='bg-gradient-to-r bg-[#FF946D] p-5 px-10 rounded-2xl text-xl font-semibold text-white'>Subscribe</button>
        </div>
